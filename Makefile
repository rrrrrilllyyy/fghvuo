#############################################################################
# Makefile for building: Silicoin-Qt.app/Contents/MacOS/Silicoin-Qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mi. Mär 19 16:23:49 2014
# Project:  bitcoin-qt.pro
# Template: app
# Command: /usr/local/bin/qmake USE_UPNP=- -o Makefile bitcoin-qt.pro
#############################################################################
...
INCPATH       = -I/usr/local/Cellar/qt/4.8.5/mkspecs/unsupported/macx-clang-libc++ -I/usr/local/Cellar/qt/4.8.5/lib/QtCore.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.5/lib/QtCore.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.5/lib/QtNetwork.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.5/lib/QtNetwork.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.5/lib/QtGui.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.5/lib/QtGui.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.5/include -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -I/usr/local/Cellar/boost/1.55.0/include/boost -I/usr/local/Cellar/berkeley-db4/4.8.30/include -I/usr/local/Cellar/openssl/1.0.1f/include/openssl -Ibuild -Ibuild -F/usr/local/Cellar/qt/4.8.5/lib
LINK          = clang++
LFLAGS        = -headerpad_max_install_names -stdlib=libc++ -mmacosx-version-min=10.7 -fstack-protector-all -arch x86_64 -pthread
LIBS          = $(SUBLIBS) -F/usr/local/Cellar/qt/4.8.5/lib -L/usr/local/Cellar/qt/4.8.5/lib /Users/Sean/Desktop/Bitcoin_compile/Silicoin/src/leveldb/libleveldb.a /Users/Sean/Desktop/Bitcoin_compile/Silicoin/src/leveldb/libmemenv.a -framework Foundation -framework ApplicationServices -framework AppKit -framework CoreServices -L/usr/local/Cellar/boost/1.55.0/lib -L/usr/local/Cellar/berkeley-db4/4.8.30/lib -L/usr/local/Cellar/openssl/1.0.1f/lib -lssl -lcrypto -ldb_cxx-4.8 -lboost_system-mt -lboost_filesystem-mt -lboost_program_options-mt -lboost_thread-mt -lboost_chrono-mt -framework QtGui -L/opt/X11/lib -L/usr/local/Cellar/qt/4.8.5/lib -F/usr/local/Cellar/qt/4.8.5/lib -framework QtCore -framework QtNetwork 
AR            = ar cq
RANLIB        = ranlib -s
...
SOURCES       = src/qt/bitcoin.cpp \
		...
		src/serial_communication.cpp build/moc_bitcoingui.cpp \
...
DIST          = /usr/local/Cellar/qt/4.8.5/mkspecs/common/unix.conf \
		...
		bitcoin-qt.pro
QMAKE_TARGET  = Silicoin-Qt
DESTDIR       = 
TARGET        = Silicoin-Qt.app/Contents/MacOS/Silicoin-Qt
...
all: Makefile Silicoin-Qt.app/Contents/PkgInfo Silicoin-Qt.app/Contents/Resources/empty.lproj Silicoin-Qt.app/Contents/Info.plist Silicoin-Qt.app/Contents/Resources/silicoin.icns $(TARGET)

$(TARGET): /Users/Sean/Desktop/Bitcoin_compile/Silicoin/src/leveldb/libleveldb.a /Users/Sean/Desktop/Bitcoin_compile/Silicoin/build/build.h build/ui_sendcoinsdialog.h build/ui_coincontroldialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) Silicoin-Qt.app/Contents/MacOS/ || $(MKDIR) Silicoin-Qt.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: bitcoin-qt.pro  /usr/local/Cellar/qt/4.8.5/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.5/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/clang.conf \
...
Silicoin-Qt.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) Silicoin-Qt.app/Contents || $(MKDIR) Silicoin-Qt.app/Contents 
	@$(DEL_FILE) Silicoin-Qt.app/Contents/PkgInfo
	@echo "APPL????" >Silicoin-Qt.app/Contents/PkgInfo
Silicoin-Qt.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) Silicoin-Qt.app/Contents/Resources || $(MKDIR) Silicoin-Qt.app/Contents/Resources 
	@touch Silicoin-Qt.app/Contents/Resources/empty.lproj
	
Silicoin-Qt.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) Silicoin-Qt.app/Contents || $(MKDIR) Silicoin-Qt.app/Contents 
	@$(DEL_FILE) Silicoin-Qt.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,0.8,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,silicoin.icns,g" -e "s,@EXECUTABLE@,Silicoin-Qt,g" -e "s,@TYPEINFO@,????,g" share/qt/Info.plist >Silicoin-Qt.app/Contents/Info.plist
Silicoin-Qt.app/Contents/Resources/silicoin.icns: src/qt/res/icons/silicoin.icns
	@$(CHK_DIR_EXISTS) Silicoin-Qt.app/Contents/Resources/ || $(MKDIR) Silicoin-Qt.app/Contents/Resources/ 
	@$(DEL_FILE) Silicoin-Qt.app/Contents/Resources/silicoin.icns
	@$(COPY_FILE) src/qt/res/icons/silicoin.icns Silicoin-Qt.app/Contents/Resources/silicoin.icns
dist: 
	@$(CHK_DIR_EXISTS) build/Silicoin-Qt0.8.6.1 || $(MKDIR) build/Silicoin-Qt0.8.6.1 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Silicoin-Qt0.8.6.1/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/Silicoin-Qt0.8.6.1/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm src/qt/macnotificationhandler.mm build/Silicoin-Qt0.8.6.1/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/coincontrol.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/scrypt.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/macnotificationhandler.h src/qt/splashscreen.h src/serial_communication.h src/qt/macdockiconhandler.h src/qt/macnotificationhandler.h build/Silicoin-Qt0.8.6.1/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/Silicoin-Qt0.8.6.1/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/scrypt.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp src/serial_communication.cpp build/Silicoin-Qt0.8.6.1/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm src/qt/macnotificationhandler.mm build/Silicoin-Qt0.8.6.1/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/coincontroldialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui build/Silicoin-Qt0.8.6.1/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/Silicoin-Qt0.8.6.1/ && (cd `dirname build/Silicoin-Qt0.8.6.1` && $(TAR) Silicoin-Qt0.8.6.1.tar Silicoin-Qt0.8.6.1 && $(COMPRESS) Silicoin-Qt0.8.6.1.tar) && $(MOVE) `dirname build/Silicoin-Qt0.8.6.1`/Silicoin-Qt0.8.6.1.tar.gz . && $(DEL_FILE) -r build/Silicoin-Qt0.8.6.1


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /Users/Sean/Desktop/Bitcoin_compile/Silicoin/src/leveldb/libleveldb.a; cd /Users/Sean/Desktop/Bitcoin_compile/Silicoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
distclean: clean
	-$(DEL_FILE) -r Silicoin-Qt.app
	-$(DEL_FILE) Makefile


/Users/Sean/Desktop/Bitcoin_compile/Silicoin/src/leveldb/libleveldb.a: FORCE
	cd /Users/Sean/Desktop/Bitcoin_compile/Silicoin/src/leveldb && CC=clang CXX=clang++ $(MAKE) OPT="-pipe -stdlib=libc++ -mmacosx-version-min=10.7 -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/Users/Sean/Desktop/Bitcoin_compile/Silicoin/build/build.h: FORCE
	cd /Users/Sean/Desktop/Bitcoin_compile/Silicoin; /bin/sh share/genbuild.sh /Users/Sean/Desktop/Bitcoin_compile/Silicoin/build/build.h
...
build/serial_communication.o: src/serial_communication.cpp src/serial_communication.h \
		src/util.h \
		src/uint256.h \
		src/netbase.h \
		src/serialize.h \
		...
		src/clientversion.h \
		src/compat.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/serial_communication.o src/serial_communication.cpp
