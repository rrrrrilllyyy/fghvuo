...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Silicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"silicointools.com", "dnsseed.silicointools.com"},
    {"silicoinpool.org", "dnsseed.silicoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"silicointools.com", "testnet-seed.silicointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Silicoin is probably already running."), addrBind.ToString().c_str());
        else
