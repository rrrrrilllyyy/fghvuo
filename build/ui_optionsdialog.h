...
public:
    ...
    QWidget *tab;
    QLineEdit *miner_port;
    QLabel *transactionFeeInfoLabel_2;
    QPushButton *miner_connectButton;
    QTextBrowser *miner_info_output;
    QPushButton *miner_disconnectButton;
    QPushButton *miner_resetButton;
    QPushButton *miner_testButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        miner_port = new QLineEdit(tab);
        miner_port->setObjectName(QString::fromUtf8("miner_port"));
        miner_port->setGeometry(QRect(170, 60, 171, 21));
        transactionFeeInfoLabel_2 = new QLabel(tab);
        transactionFeeInfoLabel_2->setObjectName(QString::fromUtf8("transactionFeeInfoLabel_2"));
        transactionFeeInfoLabel_2->setGeometry(QRect(20, 0, 470, 61));
        transactionFeeInfoLabel_2->setTextFormat(Qt::PlainText);
        transactionFeeInfoLabel_2->setWordWrap(true);
        miner_connectButton = new QPushButton(tab);
        miner_connectButton->setObjectName(QString::fromUtf8("miner_connectButton"));
        miner_connectButton->setGeometry(QRect(60, 90, 115, 32));
        miner_info_output = new QTextBrowser(tab);
        miner_info_output->setObjectName(QString::fromUtf8("miner_info_output"));
        miner_info_output->setGeometry(QRect(10, 150, 491, 91));
        miner_disconnectButton = new QPushButton(tab);
        miner_disconnectButton->setObjectName(QString::fromUtf8("miner_disconnectButton"));
        miner_disconnectButton->setGeometry(QRect(200, 90, 115, 32));
        miner_resetButton = new QPushButton(tab);
        miner_resetButton->setObjectName(QString::fromUtf8("miner_resetButton"));
        miner_resetButton->setGeometry(QRect(340, 90, 115, 32));
        miner_testButton = new QPushButton(tab);
        miner_testButton->setObjectName(QString::fromUtf8("miner_testButton"));
        miner_testButton->setGeometry(QRect(200, 120, 115, 32));
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Silicoin after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Silicoin on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Silicoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Silicoin network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Silicoin.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show Silicoin addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        ...
        miner_port->setText(QString());
        transactionFeeInfoLabel_2->setText(QApplication::translate("OptionsDialog", "Please enter the name of the serial port to which Silicoin hardware is connected.\n"
"For example \"COM1\" on Windows, and \"/dev/ttyS0\" on POSIX platforms.", 0, QApplication::UnicodeUTF8));
        miner_connectButton->setText(QApplication::translate("OptionsDialog", "Connect", 0, QApplication::UnicodeUTF8));
        miner_disconnectButton->setText(QApplication::translate("OptionsDialog", "Disconnect", 0, QApplication::UnicodeUTF8));
        miner_resetButton->setText(QApplication::translate("OptionsDialog", "Reset", 0, QApplication::UnicodeUTF8));
        miner_testButton->setText(QApplication::translate("OptionsDialog", "Test", 0, QApplication::UnicodeUTF8));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("OptionsDialog", "HWsetup", 0, QApplication::UnicodeUTF8));
