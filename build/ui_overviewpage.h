...
public:
    ...
    QPushButton *start_minerButton;
    QTextBrowser *miner_outputBox;
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelBalance->setText(QString::fromUtf8("0 SILC"));
        ...
        labelUnconfirmed->setText(QString::fromUtf8("0 SILC"));
        ...
        labelImmature->setText(QString::fromUtf8("0 SILC"));
        ...
        start_minerButton = new QPushButton(OverviewPage);
        start_minerButton->setObjectName(QString::fromUtf8("start_minerButton"));

        verticalLayout_2->addWidget(start_minerButton);

        miner_outputBox = new QTextBrowser(OverviewPage);
        miner_outputBox->setObjectName(QString::fromUtf8("miner_outputBox"));

        verticalLayout_2->addWidget(miner_outputBox);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Silicoin network after a connection is established, but this process has not completed yet.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        start_minerButton->setText(QApplication::translate("OverviewPage", "Start Miner", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("OverviewPage", "<b>Recent transactions</b>", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Silicoin network after a connection is established, but this process has not completed yet.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
