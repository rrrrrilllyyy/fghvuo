...
isEmpty(BOOST_INCLUDE_PATH) {
    macx:BOOST_INCLUDE_PATH = /usr/local/Cellar/boost/1.55.0/include/boost
}
...
macx:ICON = src/qt/res/icons/silicoin.icns
macx:QMAKE_CFLAGS_THREAD += -pthread
macx:QMAKE_LFLAGS_THREAD += -pthread
macx:QMAKE_CXXFLAGS_THREAD += -pthread
macx:QMAKE_INFO_PLIST = share/qt/Info.plist

OPENSSL_INCLUDE_PATH = /usr/local/Cellar/openssl/1.0.1f/include/openssl
OPENSSL_LIB_PATH = /usr/local/Cellar/openssl/1.0.1f/lib
